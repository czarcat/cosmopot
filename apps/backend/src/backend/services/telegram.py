...
class TelegramAuthService:
    ...
    async def authenticate(
        ...
        *,
        ...
        return TelegramAuthResult(user=user, access_token=token, expires_at=expires_at)
    ...
    async def _persist_session(
        ...
        *,
        ...
        await services.open_session(session, session_data)
    ...
    def _build_email(self, payload: TelegramLoginPayload) -> str:
        ...
        return f"{base}.{payload.id}@telegram.local"
